...
local awesome_overrides = function(theme)
    ...
    theme.tooltip_shape = function(cr, w, h) gears.shape.rounded_rect(cr, w, h, dpi(3)) end
    ...
    theme.taglist_bg_urgent = {
        ...
        from = {0, 0},
        to = {0, dpi(40)},
        stops = {{0, theme.accent.hue_800}, {0.07, theme.accent.hue_800}, {0.08, theme.background.hue_800}, {0.95, theme.accent.hue_300}}
    }
    theme.taglist_bg_focus = {
        type = 'linear',
        from = {0, 0},
        to = {0, dpi(40)},
        stops = {{0, theme.accent.hue_800}, {0.07, theme.accent.hue_800}, {0.08, theme.background.hue_800}, {0.95, theme.background.hue_600}}
    }
    -- Tasklist
    ...
    theme.tasklist_bg_focus = {
        ...
        from = {0, 0},
        to = {0, dpi(40)},
        stops = {{0, theme.primary.hue_800}, {0.07, theme.primary.hue_800}, {0.08, theme.background.hue_800}, {0.95, theme.background.hue_600}}
    }
